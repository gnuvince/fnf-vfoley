...
\begin{frame}
  ...
  \big{\ruleNum. An object is released when its owner goes out of scope}
\end{frame}
...
\begin{frame}
  \big{\ruleNum. A \emph{shared borrow} is a read-only pointer to a value}

  \big{\ruleNum. A borrow does not own the value it points to}
\end{frame}
...
\begin{frame}
  \big{\ruleNum. Many shared borrows to the same value are allowed}
\end{frame}
...
\begin{frame}
  \big{\ruleNum. A \emph{mutable borrow} is a read-write pointer to a value}
\end{frame}
...
\begin{frame}
  \big{\ruleNum. A single mutable borrow to a value may exist at any given time}
\end{frame}
...
\begin{frame}
  \big{\ruleNum. Shared and mutable borrows to the same value cannot coexist}
\end{frame}
