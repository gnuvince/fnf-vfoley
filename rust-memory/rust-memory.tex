...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item The compiler \textbf{must} understand your code;
    \item Some valid code \textbf{will} be rejected.
  \end{itemize}
\end{frame}

\begin{frame}
  \textquote[Programming Rust, O'Reilly]{
    Rust's radical wager---the claim on which it stakes its success, and
...
\begin{frame}
  \big{1. An object has a \textit{single} owner}
